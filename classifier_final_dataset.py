...
class ML_Algo:
    ...
    def execute_multiclassifer(self, final_dataset_path, split_size):
        dl = DataLoader()
        ...
        print("---" * 20)
        print("1. Model: KNN for Multiclass")
        classifier.multiClassify_using_knn(np_X_train, np_X_test, np_Y_train, np_Y_test)
    ...
    def execute_regressor(self, final_dataset_path, split_size):
        ...
        regressor = Regressor()
        regressor.regression_using_knn(np_X_train, np_X_test, np_Y_train, np_Y_test)
